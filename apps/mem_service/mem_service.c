...
#define MEM_SERVICE_UPGRADE_ROLLBACK_POLICY_EXPECTED_CHECKSUM 0x536bceb1U
...
#define MEM_SERVICE_PACKAGE_MANIFEST_EXPECTED_CHECKSUM 0xae91905bU
...
#define MEM_SERVICE_COMPAT_MATRIX_EXPECTED_CHECKSUM 0xeabc1584U
#define MEM_SERVICE_COMPAT_MATRIX_STATUS_COUNT 11U
#define MEM_SERVICE_COMPAT_BASELINE_V1_EXPECTED_LEN 1252U
#define MEM_SERVICE_COMPAT_BASELINE_V1_EXPECTED_CHECKSUM 0x3ac81990U
#define MEM_SERVICE_COMPAT_OLD_NEW_MATRIX_EXPECTED_LEN 1734U
#define MEM_SERVICE_COMPAT_OLD_NEW_MATRIX_EXPECTED_CHECKSUM 0x2c2ea92bU
...
static int run_allocate_object(int argc, char **argv)
{
    ...
    if (append_required_payload_field(payload, sizeof(payload), argc, argv, "--key", "key") != 0 ||
        ...
        append_optional_payload_field(payload, sizeof(payload), argc, argv, "--home-node", "home_node") != 0 ||
