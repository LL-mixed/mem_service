...
SERVICE_MODEL_RANGE_WAIT_FLOW_C = (
    SERVICE_DIR / "mem_service_model_range_wait_flow.c"
)
SERVICE_MODEL_RANGE_PUBLISH_FLOW_C = (
    SERVICE_DIR / "mem_service_model_range_publish_flow.c"
)
SERVICE_MODEL_RANGE_KV_STATE_FLOW_C = SERVICE_DIR / "mem_service_model_range_kv_state_flow.c"
SERVICE_MODEL_TERMINAL_TOKEN_FLOW_C = (
...
SERVICE_MODEL_DECODE_BARRIER_C = SERVICE_DIR / "mem_service_model_decode_barrier.c"
...
class MemServiceRecordRecyclingTests(unittest.TestCase):
    @unittest.skipUnless(
        BUILD_INITRAMFS.exists(),
        "ub_sim scripts/build_initramfs.sh is not part of the standalone repo",
    )
    def test_ub_sim_guest_integration_contract(self):
        ...
        self.assertIn(
            'MEM_SERVICE_MODEL_DECODE_BARRIER_SRC="$ROOT_DIR/components/mem_service/mem_service_model_decode_barrier.c"',
            build_script,
        )
        self.assertIn(
            'MEM_SERVICE_MODEL_RANGE_KV_STATE_FLOW_SRC="$ROOT_DIR/components/mem_service/mem_service_model_range_kv_state_flow.c"',
            build_script,
        )
        self.assertIn(
            'MEM_SERVICE_MODEL_TERMINAL_TOKEN_FLOW_SRC="$ROOT_DIR/components/mem_service/mem_service_model_terminal_token_flow.c"',
            build_script,
        )
        self.assertIn(
            'MEM_SERVICE_MODEL_RANGE_WAIT_FLOW_SRC="$ROOT_DIR/components/mem_service/mem_service_model_range_wait_flow.c"',
            build_script,
        )
        self.assertIn(
            'MEM_SERVICE_MODEL_RANGE_PUBLISH_FLOW_SRC="$ROOT_DIR/components/mem_service/mem_service_model_range_publish_flow.c"',
            build_script,
        )
        self.assertIn(
        ...
        self.assertIn(
            ...
            '"$MEM_SERVICE_QWEN3_RUNTIME_SRC" "$MEM_SERVICE_MODEL_DECODE_BARRIER_SRC" '
            '"$MEM_SERVICE_MODEL_RANGE_KV_STATE_FLOW_SRC" "$MEM_SERVICE_MODEL_TERMINAL_TOKEN_FLOW_SRC" '
            '"$MEM_SERVICE_MODEL_RANGE_WAIT_FLOW_SRC" '
            '"$MEM_SERVICE_MODEL_RANGE_PUBLISH_FLOW_SRC" '
        ...
        self.assertIn(
            'run_binary "linqu_mem_service_retention_fixtures" '
            "/bin/linqu_mem_service retention-fixtures",
            run_app,
        )
        self.assertIn(
            'run_binary "linqu_mem_service_checkpoint_retention_fixtures" '
            "/bin/linqu_mem_service checkpoint-retention-fixtures",
            run_app,
        )
        self.assertIn(
            'run_binary "linqu_mem_service_payload_gc_fixtures" '
            "/bin/linqu_mem_service payload-gc-fixtures",
            run_app,
        )
        self.assertIn(
            'run_binary "linqu_mem_service_record_retention_fixtures" '
            "/bin/linqu_mem_service record-retention-fixtures",
            run_app,
        )
        self.assertIn(
    ...
    def test_mem_service_has_cli_without_demo_naming(self):
        ...
        self.assertIn("MEM_SERVICE_COMPAT_MATRIX_EXPECTED_LEN 2226U", cli_source)
        self.assertIn(
            "MEM_SERVICE_COMPAT_MATRIX_EXPECTED_CHECKSUM 0xeabc1584U",
            cli_source,
        )
        self.assertIn("MEM_SERVICE_COMPAT_BASELINE_V1_EXPECTED_LEN 1252U", cli_source)
        self.assertIn(
            "MEM_SERVICE_COMPAT_BASELINE_V1_EXPECTED_CHECKSUM 0x3ac81990U",
            cli_source,
        )
        self.assertIn("MEM_SERVICE_COMPAT_OLD_NEW_MATRIX_EXPECTED_LEN 1734U", cli_source)
        self.assertIn(
            "MEM_SERVICE_COMPAT_OLD_NEW_MATRIX_EXPECTED_CHECKSUM 0x2c2ea92bU",
            cli_source,
        )
        self.assertIn("MEM_SERVICE_WIRE_SCHEMA_MANIFEST_EXPECTED_LEN 18318U", cli_source)
        self.assertIn(
            "MEM_SERVICE_WIRE_SCHEMA_MANIFEST_EXPECTED_CHECKSUM 0x5c6a250dU",
            cli_source,
        )
        self.assertIn("MEM_SERVICE_ADMIN_OUTPUT_SCHEMA_EXPECTED_LEN 7648U", cli_source)
        self.assertIn(
            "MEM_SERVICE_ADMIN_OUTPUT_SCHEMA_EXPECTED_CHECKSUM 0xd4f33080U",
            cli_source,
        )
        self.assertIn("MEM_SERVICE_UPGRADE_ROLLBACK_POLICY_EXPECTED_LEN 2144U", cli_source)
        self.assertIn(
            "MEM_SERVICE_UPGRADE_ROLLBACK_POLICY_EXPECTED_CHECKSUM 0x536bceb1U",
            cli_source,
        )
        ...
        self.assertIn(
            "MEM_SERVICE_PACKAGE_MANIFEST_EXPECTED_CHECKSUM 0xae91905bU",
            cli_source,
        )
        ...
        self.assertIn("MEM_SERVICE_PACKAGE_MANIFEST_INSTALLED_FILE_COUNT 57U", cli_source)
        self.assertIn(
        ...
        self.assertIn('strcmp(argv[1], "checkpoint-retention-fixtures")', cli_source)
        self.assertIn('strcmp(argv[1], "payload-gc-fixtures")', cli_source)
        self.assertIn('strcmp(argv[1], "record-retention-fixtures")', cli_source)
        ...
        self.assertIn("mem_service_run_runtime_quota_fixture_check", cli_source)
        self.assertIn("mem_service_run_retention_fixture_check", cli_source)
        ...
        self.assertIn('strcmp(argv[1], "materialize-object")', cli_source)
        ...
        self.assertIn(
            "$(ROOT)/scripts/run_mem_service_release_certification_ci.sh",
            cli_makefile,
        )
        self.assertIn("INSTALL_SCRIPTSDIR := $(INSTALL_DATADIR)/scripts", cli_makefile)
        self.assertIn(
            "cp $(MEM_SERVICE_RELEASE_SCRIPTS) $(INSTALL_SCRIPTSDIR)/",
            cli_makefile,
        )
        self.assertIn(
            "test -x $(INSTALL_SCRIPTSDIR)/verify_mem_service_installed_layout.sh",
            cli_makefile,
        )
        self.assertIn(
            "$(INSTALL_SCRIPTSDIR)/verify_mem_service_installed_layout.sh --no-runtime",
            cli_makefile,
        )
        self.assertIn(
        ...
        self.assertIn(
            "test -x $(INSTALL_SCRIPTSDIR)/run_mem_service_release_certification_ci.sh",
            cli_makefile,
        )
        self.assertIn(
        ...
        self.assertIn("^admin_output_schema_checksum=0xd4f33080$$", cli_makefile)
        ...
        self.assertIn("^package_manifest_checksum=0xae91905b$$", cli_makefile)
        ...
        self.assertIn(
            "$(PKG_CONFIG) --define-prefix --variable=sdk_sources lingqu-mem-service",
            cli_makefile,
        )
        ...
        self.assertIn("^upgrade_rollback_policy_checksum=0x536bceb1$$", cli_makefile)
        self.assertIn(
        ...
        self.assertIn("^payload_ownership_matrix=certified$$", cli_makefile)
        self.assertIn("^payload_ownership_scope=artifact-query-expected-owner$$", cli_makefile)
        self.assertIn(
            "^payload_ownership_gate=serving-fail-closed-fixtures,pretraining-fail-closed-fixtures$$",
            cli_makefile,
        )
        ...
        self.assertIn("^compat_matrix_checksum=0xeabc1584$$", cli_makefile)
        self.assertIn("^compat_baseline=share/lingqu/mem_service/compat-baseline-v1.txt$$", cli_makefile)
        self.assertIn("^compat_baseline_checksum=0x3ac81990$$", cli_makefile)
        self.assertIn("^compat_old_new_matrix=share/lingqu/mem_service/compat-old-new-matrix.txt$$", cli_makefile)
        self.assertIn("^compat_old_new_matrix_checksum=0x2c2ea92b$$", cli_makefile)
        ...
        self.assertIn("^payload_block_backend=sealed-local-block-v1,sealed-chunked-block-v1,transport-loopback-block-v1,transport-tcp-block-v1,ub-ssd-gsva-v1$$", cli_makefile)
        ...
        self.assertIn("^remote_payload_production_transport_ci_preflight=scripts/run_mem_service_remote_transport_ci.sh --preflight$$", cli_makefile)
        ...
        self.assertIn("^remote_payload_production_transport_bundle=remote-transport-certification-bundle$$", cli_makefile)
        self.assertIn("^remote_payload_production_transport_bundle_verify=remote-transport-certification-bundle-verify$$", cli_makefile)
        self.assertIn("^remote_payload_production_transport_bundle_script=scripts/verify_mem_service_remote_transport_bundle.sh$$", cli_makefile)
        ...
        self.assertIn("wire_schema_manifest_checksum=0x5c6a250d", release_manifest)
        ...
        self.assertIn("admin_output_schema_checksum=0xd4f33080", release_manifest)
        ...
        self.assertIn("package_manifest_checksum=0xae91905b", release_manifest)
        self.assertIn(
            "release_readiness_evidence_verify=release-readiness --ops-evidence-file --remote-transport-evidence-file",
            release_manifest,
        )
        ...
        self.assertIn("deployment_quota_contract=max-records+max-payload-bytes", release_manifest)
        self.assertIn("deployment_quota_gate=config-fixtures", release_manifest)
        self.assertIn("retention_policy=manual-or-audit-log-limit", release_manifest)
        self.assertIn(
            "retention_policy_gate=config-fixtures,retention-fixtures",
            release_manifest,
        )
        self.assertIn("checkpoint_retention_policy=manual-or-latest-limit", release_manifest)
        self.assertIn(
            "checkpoint_retention_gate=config-fixtures,checkpoint-retention-fixtures",
            release_manifest,
        )
        self.assertIn("record_retention_policy=manual-or-global-kind-tenant-latest-or-ttl", release_manifest)
        self.assertIn(
        ...
        self.assertIn("upgrade_rollback_policy_checksum=0x536bceb1", release_manifest)
        self.assertIn(
            "upgrade_rollback_runtime_gate=upgrade-rollback-runtime-fixtures",
            release_manifest,
        )
        ...
        self.assertIn("payload_ownership_matrix=certified", release_manifest)
        self.assertIn("payload_ownership_scope=artifact-query-expected-owner", release_manifest)
        self.assertIn(
            "payload_ownership_gate=serving-fail-closed-fixtures,pretraining-fail-closed-fixtures",
            release_manifest,
        )
        ...
        self.assertIn("compat_matrix_checksum=0xeabc1584", release_manifest)
        self.assertIn("compat_baseline=share/lingqu/mem_service/compat-baseline-v1.txt", release_manifest)
        self.assertIn("compat_baseline_checksum=0x3ac81990", release_manifest)
        self.assertIn("compat_old_new_matrix=share/lingqu/mem_service/compat-old-new-matrix.txt", release_manifest)
        self.assertIn("compat_old_new_matrix_checksum=0x2c2ea92b", release_manifest)
        self.assertIn(
        ...
        self.assertIn("payload_block_backend=sealed-local-block-v1,sealed-chunked-block-v1,transport-loopback-block-v1,transport-tcp-block-v1,ub-ssd-gsva-v1", release_manifest)
        ...
        self.assertIn("operation=materialize_object:19", release_manifest)
        self.assertIn(
        ...
        self.assertIn("payload_block_backends=5", cli_source)
        ...
        self.assertIn("operation_count=40", (CLI_DIR / "wire-schema.txt").read_text())
        self.assertIn("field_count=239", (CLI_DIR / "wire-schema.txt").read_text())
        self.assertIn(
            "field=resolve_runtime_handoff.expected_owner type=u32 required=0",
            (CLI_DIR / "wire-schema.txt").read_text(),
        )
        self.assertIn(
            "field=query_execution_artifact.expected_owner type=u32 required=0",
            (CLI_DIR / "wire-schema.txt").read_text(),
        )
        self.assertIn(
            "field=query_training_artifact.expected_owner type=u32 required=0",
            (CLI_DIR / "wire-schema.txt").read_text(),
        )
        ...
        self.assertIn("installed_file_count=57", package_manifest)
        ...
        self.assertIn("release_script_root=share/lingqu/mem_service/scripts", package_manifest)
        self.assertIn("release_certification_ci=scripts/run_mem_service_release_certification_ci.sh", package_manifest)
        self.assertIn(
            "release_certification_preflight=scripts/run_mem_service_release_certification_ci.sh --preflight",
            package_manifest,
        )
        ...
        self.assertIn("linux_ops_ci=scripts/run_mem_service_linux_ops_ci.sh", package_manifest)
        self.assertIn(
            "linux_ops_ci_preflight=scripts/run_mem_service_linux_ops_ci.sh --preflight",
            package_manifest,
        )
        ...
        self.assertIn("deployment_quota_contract=max-records+max-payload-bytes", package_manifest)
        self.assertIn("deployment_quota_gate=config-fixtures", package_manifest)
        self.assertIn("retention_policy=manual-or-audit-log-limit", package_manifest)
        self.assertIn(
            "retention_policy_gate=config-fixtures,retention-fixtures",
            package_manifest,
        )
        self.assertIn("checkpoint_retention_policy=manual-or-latest-limit", package_manifest)
        self.assertIn(
            "checkpoint_retention_gate=config-fixtures,checkpoint-retention-fixtures",
            package_manifest,
        )
        self.assertIn("record_retention_policy=manual-or-global-kind-tenant-latest-or-ttl", package_manifest)
        self.assertIn(
            "record_retention_gate=config-fixtures,record-retention-fixtures",
            package_manifest,
        )
        ...
        self.assertIn("file_class=pkgconfig count=1", package_manifest)
        ...
        self.assertIn("required_gate_count=34", package_manifest)
        ...
        self.assertIn("required_gate=checkpoint-retention-fixtures", package_manifest)
        self.assertIn("required_gate=payload-gc-fixtures", package_manifest)
        self.assertIn("required_gate=record-retention-fixtures", package_manifest)
        ...
        self.assertIn("client_record_abi_size=808", api_abi_policy)
        ...
        self.assertIn("wire_schema_manifest_checksum=0x5c6a250d", compat_matrix)
        self.assertIn("compat_matrix_checksum=0xeabc1584", (CLI_DIR / "compat-baseline-v1.txt").read_text())
        self.assertIn("compat_baseline_checksum=0x3ac81990", (CLI_DIR / "compat-old-new-matrix.txt").read_text())
        ...
        self.assertIn(
            "field=checkpoint_retention type=enum values=manual,latest:<records>",
            config_schema,
        )
        self.assertIn(
            "field=record_retention type=enum values=manual,latest:<records>,ttl-ms:<age-ms>,kind:<record-kind>:latest:<records>,kind:<record-kind>:ttl-ms:<age-ms>,tenant:<owner-node>:latest:<records>,tenant:<owner-node>:ttl-ms:<age-ms>",
            config_schema,
        )
        ...
        self.assertIn("checkpoint_retention=manual", config_example)
        self.assertIn("record_retention=manual", config_example)
        ...
        self.assertIn("checkpoint_retention=manual", config_runtime)
        self.assertIn("record_retention=manual", config_runtime)
        ...
        self.assertIn("checkpoint_retention=manual", config_host_runtime)
        self.assertIn("record_retention=manual", config_host_runtime)
        ...
        self.assertIn("#define MEM_SERVICE_CLIENT_RECORD_ABI_SIZE 808U", client_header)
    ...
    def test_mem_service_has_stable_wire_and_unix_daemon_boundary(self):
        ...
        self.assertIn("mem_service_send_request_with_options", client_source)
        ...
        self.assertIn("mem_service_send_request_with_options", cli_source)
        ...
        self.assertIn("mem_service_materialize_object", daemon)
        ...
        self.assertIn(
            'mem_service_expect_u32("op_materialize_object",',
            daemon,
        )
        self.assertIn("mem_service_client_materialize_object", client)
        self.assertIn("mem_service_client_materialize_object", client_source)
    ...
    def test_obmm_object_contract_is_split_for_host_guest_reuse(self):
        ...
        self.assertIn("MEM_SERVICE_OBMM_KV_STATE_SLOT_BYTES", object_contract)
        ...
        self.assertNotRegex(
            internal_header,
            r"#define MEM_SERVICE_OBMM_KV_STATE_SLOT_BYTES\s+0x",
        )
    ...
    @unittest.skipUnless(
        SIM_UAPI_RS.exists(),
        "ub_sim crates/sim-uapi/src/lib.rs is not part of the standalone repo",
    )
    ...
    def test_model_runtime_helpers_are_split_from_service_core(self):
        source = SERVICE_C.read_text()
        qwen3_runtime = SERVICE_QWEN3_RUNTIME_C.read_text()
        readme = (SERVICE_DIR / "README.md").read_text()
        ...
        self.assertIn("mem_service_model_payload_checksum", qwen3_runtime)
        self.assertIn("mem_service_model_kv_state_alloc", qwen3_runtime)
        ...
        self.assertIn("model-neutral payload checksum", readme)
        self.assertIn("model-neutral runtime helpers", readme)
        self.assertFalse((SERVICE_DIR / "mem_service_qwen3_runtime.inc").exists())
        self.assertNotRegex(
            source,
            r"static uint64_t mem_service_model_payload_checksum"
            r"\(const uint8_t \*bytes,",
        )
        self.assertNotRegex(
            source,
            r"static int mem_service_model_kv_state_block_span"
            r"\(uint64_t payload_len,",
        )

    def test_model_decode_barrier_is_split_from_runtime_main(self):
        source = SERVICE_C.read_text()
        decode_barrier = SERVICE_MODEL_DECODE_BARRIER_C.read_text()
        readme = (SERVICE_DIR / "README.md").read_text()
        ...
        self.assertIn("mem_service_sync_remote_range", decode_barrier)
        self.assertIn("rt->payload_offset + slot_offset", decode_barrier)
        self.assertIn("ready_mask & (1U << i)", decode_barrier)
    ...
    def test_model_runtime_range_wait_flow_is_split_from_runtime_main(self):
        ...
        self.assertIn(
            "mem_service_model_read_runtime_input_from_ub_ssd_gsva_backend",
            range_wait_flow,
        )
        ...
        self.assertIn("token_desc.region_id", range_wait_flow)
        self.assertIn("mem_service_try_push_obmm_record_desc_to", terminal_flow)
        self.assertNotIn(
        ...
        self.assertIn("model-neutral runtime range", readme)
    ...
    def test_model_runtime_range_publish_flow_is_split_from_runtime_main(self):
        source = SERVICE_C.read_text()
        range_publish_flow = SERVICE_MODEL_RANGE_PUBLISH_FLOW_C.read_text()
        readme = (SERVICE_DIR / "README.md").read_text()
        ...
        self.assertIn(
            "mem_service_model_publish_record_to_ub_ssd_gsva_backend",
            range_publish_flow,
        )
        ...
        self.assertIn(
            '"model_range_runtime_output"',
            range_publish_flow,
        )
        self.assertIn(
            '"model_range_kv_state"',
            range_publish_flow,
        )
        self.assertIn(
        ...
        self.assertIn("downstream descriptor publication", readme)
        self.assertFalse(
    ...
    def test_model_range_kv_state_flow_is_split_from_runtime_main(self):
        source = SERVICE_C.read_text()
        kv_state_flow = SERVICE_MODEL_RANGE_KV_STATE_FLOW_C.read_text()
        readme = (SERVICE_DIR / "README.md").read_text()
        ...
        self.assertIn("model-neutral range KV", readme)
    ...
    def test_model_terminal_token_flow_is_split_from_runtime_main(self):
        source = SERVICE_C.read_text()
        terminal_token_flow = SERVICE_MODEL_TERMINAL_TOKEN_FLOW_C.read_text()
        readme = (SERVICE_DIR / "README.md").read_text()
        ...
        self.assertIn("model-neutral terminal", readme)
        self.assertIn("standalone model", readme)
    ...
    @unittest.skipUnless(
        GUEST_C.exists(),
        "ub_sim apps/llm_infer/llm_infer.c is not part of the standalone repo",
    )
    ...
    def test_model_range_kv_state_uses_tiered_block_spans(self):
        source = (
        ...
        slot_bytes = re.search(
            r"#define MEM_SERVICE_OBMM_KV_STATE_SLOT_BYTES\s+0x([0-9a-fA-F]+)ULL",
            source,
        )
        ...
        self.assertIn("mem_service_model_kv_state_block_span", source)
        self.assertIn("mem_service_model_kv_state_alloc", source)
        self.assertIn("block_count =", source)
        self.assertIn("reserved_bytes = block_count * block_bytes", source)
        self.assertNotIn("kv_payload_len > MEM_SERVICE_OBMM_KV_STATE_SLOT_BYTES", source)

    def test_model_range_kv_state_flow_uses_ub_ssd_gsva_backend_when_attached(self):
        source = SERVICE_MODEL_RANGE_KV_STATE_FLOW_C.read_text()

        self.assertIn('#include "mem_service_ub_ssd_gsva_io.h"', source)
        self.assertIn(
            "mem_service_model_kv_publish_record_to_ub_ssd_gsva_backend",
            source,
        )
        self.assertIn(
            "mem_service_model_kv_read_from_ub_ssd_gsva_backend",
            source,
        )
