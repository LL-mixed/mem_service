...
class MemServiceRecordRecyclingTests(unittest.TestCase):
    ...
    def test_mem_service_has_cli_without_demo_naming(self):
        ...
        self.assertIn(
            "MEM_SERVICE_COMPAT_MATRIX_EXPECTED_CHECKSUM 0xbcb85c0fU",
            cli_source,
        )
        self.assertIn("MEM_SERVICE_COMPAT_BASELINE_V1_EXPECTED_LEN 1252U", cli_source)
        self.assertIn(
            "MEM_SERVICE_COMPAT_BASELINE_V1_EXPECTED_CHECKSUM 0xf97cfd5fU",
            cli_source,
        )
        self.assertIn("MEM_SERVICE_COMPAT_OLD_NEW_MATRIX_EXPECTED_LEN 1734U", cli_source)
        self.assertIn(
            "MEM_SERVICE_COMPAT_OLD_NEW_MATRIX_EXPECTED_CHECKSUM 0x2277d04aU",
            cli_source,
        )
        self.assertIn("MEM_SERVICE_WIRE_SCHEMA_MANIFEST_EXPECTED_LEN 16046U", cli_source)
        self.assertIn(
            "MEM_SERVICE_WIRE_SCHEMA_MANIFEST_EXPECTED_CHECKSUM 0xe23bc83aU",
            cli_source,
        )
        ...
        self.assertIn(
            "MEM_SERVICE_UPGRADE_ROLLBACK_POLICY_EXPECTED_CHECKSUM 0x2956bdfdU",
            cli_source,
        )
        ...
        self.assertIn(
            "MEM_SERVICE_PACKAGE_MANIFEST_EXPECTED_CHECKSUM 0x1bb4128fU",
            cli_source,
        )
        ...
        self.assertIn("^package_manifest_checksum=0x1bb4128f$$", cli_makefile)
        ...
        self.assertIn("^upgrade_rollback_policy_checksum=0x2956bdfd$$", cli_makefile)
        self.assertIn(
        ...
        self.assertIn("^compat_matrix_checksum=0xbcb85c0f$$", cli_makefile)
        self.assertIn("^compat_baseline=share/lingqu/mem_service/compat-baseline-v1.txt$$", cli_makefile)
        self.assertIn("^compat_baseline_checksum=0xf97cfd5f$$", cli_makefile)
        self.assertIn("^compat_old_new_matrix=share/lingqu/mem_service/compat-old-new-matrix.txt$$", cli_makefile)
        self.assertIn("^compat_old_new_matrix_checksum=0x2277d04a$$", cli_makefile)
        ...
        self.assertIn("wire_schema_manifest_checksum=0xe23bc83a", release_manifest)
        ...
        self.assertIn("package_manifest_checksum=0x1bb4128f", release_manifest)
        self.assertIn(
            "release_readiness_evidence_verify=release-readiness --ops-evidence-file --remote-transport-evidence-file",
            release_manifest,
        )
        ...
        self.assertIn("upgrade_rollback_policy_checksum=0x2956bdfd", release_manifest)
        self.assertIn(
            "upgrade_rollback_runtime_gate=upgrade-rollback-runtime-fixtures",
            release_manifest,
        )
        ...
        self.assertIn("compat_matrix_checksum=0xbcb85c0f", release_manifest)
        self.assertIn("compat_baseline=share/lingqu/mem_service/compat-baseline-v1.txt", release_manifest)
        self.assertIn("compat_baseline_checksum=0xf97cfd5f", release_manifest)
        self.assertIn("compat_old_new_matrix=share/lingqu/mem_service/compat-old-new-matrix.txt", release_manifest)
        self.assertIn("compat_old_new_matrix_checksum=0x2277d04a", release_manifest)
        self.assertIn(
        ...
        self.assertIn("operation_count=36", (CLI_DIR / "wire-schema.txt").read_text())
        self.assertIn("field_count=207", (CLI_DIR / "wire-schema.txt").read_text())
        self.assertIn(
        ...
        self.assertIn("wire_schema_manifest_checksum=0xe23bc83a", compat_matrix)
        self.assertIn("compat_matrix_checksum=0xbcb85c0f", (CLI_DIR / "compat-baseline-v1.txt").read_text())
        self.assertIn("compat_baseline_checksum=0xf97cfd5f", (CLI_DIR / "compat-old-new-matrix.txt").read_text())
