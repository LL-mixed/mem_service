...
class MemServiceRecordRecyclingTests(unittest.TestCase):
    ...
    def test_mem_service_has_cli_without_demo_naming(self):
        ...
        self.assertIn(
            "MEM_SERVICE_COMPAT_MATRIX_EXPECTED_CHECKSUM 0x5b574449U",
            cli_source,
        )
        self.assertIn("MEM_SERVICE_COMPAT_BASELINE_V1_EXPECTED_LEN 1252U", cli_source)
        self.assertIn(
            "MEM_SERVICE_COMPAT_BASELINE_V1_EXPECTED_CHECKSUM 0xe74ef98aU",
            cli_source,
        )
        self.assertIn("MEM_SERVICE_COMPAT_OLD_NEW_MATRIX_EXPECTED_LEN 1734U", cli_source)
        self.assertIn(
            "MEM_SERVICE_COMPAT_OLD_NEW_MATRIX_EXPECTED_CHECKSUM 0x38956796U",
            cli_source,
        )
        self.assertIn("MEM_SERVICE_WIRE_SCHEMA_MANIFEST_EXPECTED_LEN 16300U", cli_source)
        self.assertIn(
            "MEM_SERVICE_WIRE_SCHEMA_MANIFEST_EXPECTED_CHECKSUM 0x5905d107U",
            cli_source,
        )
        ...
        self.assertIn(
            "MEM_SERVICE_UPGRADE_ROLLBACK_POLICY_EXPECTED_CHECKSUM 0xf4139152U",
            cli_source,
        )
        ...
        self.assertIn(
            "MEM_SERVICE_PACKAGE_MANIFEST_EXPECTED_CHECKSUM 0x0095ab54U",
            cli_source,
        )
        ...
        self.assertIn("^package_manifest_checksum=0x0095ab54$$", cli_makefile)
        ...
        self.assertIn("^upgrade_rollback_policy_checksum=0xf4139152$$", cli_makefile)
        self.assertIn(
        ...
        self.assertIn("^compat_matrix_checksum=0x5b574449$$", cli_makefile)
        self.assertIn("^compat_baseline=share/lingqu/mem_service/compat-baseline-v1.txt$$", cli_makefile)
        self.assertIn("^compat_baseline_checksum=0xe74ef98a$$", cli_makefile)
        self.assertIn("^compat_old_new_matrix=share/lingqu/mem_service/compat-old-new-matrix.txt$$", cli_makefile)
        self.assertIn("^compat_old_new_matrix_checksum=0x38956796$$", cli_makefile)
        ...
        self.assertIn("wire_schema_manifest_checksum=0x5905d107", release_manifest)
        ...
        self.assertIn("package_manifest_checksum=0x0095ab54", release_manifest)
        self.assertIn(
            "release_readiness_evidence_verify=release-readiness --ops-evidence-file --remote-transport-evidence-file",
            release_manifest,
        )
        ...
        self.assertIn("upgrade_rollback_policy_checksum=0xf4139152", release_manifest)
        self.assertIn(
            "upgrade_rollback_runtime_gate=upgrade-rollback-runtime-fixtures",
            release_manifest,
        )
        ...
        self.assertIn("compat_matrix_checksum=0x5b574449", release_manifest)
        self.assertIn("compat_baseline=share/lingqu/mem_service/compat-baseline-v1.txt", release_manifest)
        self.assertIn("compat_baseline_checksum=0xe74ef98a", release_manifest)
        self.assertIn("compat_old_new_matrix=share/lingqu/mem_service/compat-old-new-matrix.txt", release_manifest)
        self.assertIn("compat_old_new_matrix_checksum=0x38956796", release_manifest)
        self.assertIn(
        ...
        self.assertIn("operation_count=37", (CLI_DIR / "wire-schema.txt").read_text())
        self.assertIn("field_count=210", (CLI_DIR / "wire-schema.txt").read_text())
        self.assertIn(
        ...
        self.assertIn("wire_schema_manifest_checksum=0x5905d107", compat_matrix)
        self.assertIn("compat_matrix_checksum=0x5b574449", (CLI_DIR / "compat-baseline-v1.txt").read_text())
        self.assertIn("compat_baseline_checksum=0xe74ef98a", (CLI_DIR / "compat-old-new-matrix.txt").read_text())
