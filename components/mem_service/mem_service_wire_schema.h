...
static const struct mem_service_wire_payload_field
    mem_service_wire_object_put_fields[] = {
        ...
        {"backend_write", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U32, false},
        {"backend_device_path", MEM_SERVICE_WIRE_PAYLOAD_FIELD_STRING, false},
        {"backend_request_id", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U64, false},
        {"backend_source_cna", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U32, false},
        ...
        {"backend_flags", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U32, false},
        ...
        {"backend_buffer_gsva_base", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U64, false},
        {"backend_buffer_bytes", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U64, false},
        {"backend_buffer_token_id", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U32, false},
        {"backend_buffer_token_value", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U32, false},
        {"backend_buffer_key_version", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U32, false},
        {"backend_buffer_key_flags", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U32, false},
        {"backend_buffer_key_segment_id", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U64, false},
        {"backend_buffer_key_home_va", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U64, false},
        {"backend_buffer_key_size", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U64, false},
        {"backend_buffer_key_vmid", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U64, false},
        {"backend_buffer_key_asid", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U64, false},
        {"backend_buffer_key_pte_offset", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U64, false},
        {"backend_buffer_key_p_tag", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U32, false},
        {"backend_buffer_key_cache_policy", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U32, false},
        {"backend_buffer_key_epoch", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U64, false},
...
static const struct mem_service_wire_payload_field
    mem_service_wire_object_get_fields[] = {
        {"key", MEM_SERVICE_WIRE_PAYLOAD_FIELD_STRING, true},
        {"backend_read", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U32, false},
        {"backend_device_path", MEM_SERVICE_WIRE_PAYLOAD_FIELD_STRING, false},
        {"backend_request_id", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U64, false},
        {"backend_source_cna", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U32, false},
        {"backend_device_cna", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U32, false},
...
static const struct mem_service_wire_payload_field
    mem_service_wire_fence_allocation_holder_fields[] = {
        {"key", MEM_SERVICE_WIRE_PAYLOAD_FIELD_STRING, true},
        {"generation", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U64, true},
        {"node_id", MEM_SERVICE_WIRE_PAYLOAD_FIELD_STRING, true},
        {"incarnation", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U64, true},
        {"fenced_incarnation", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U64, true},
        {"idempotency_key", MEM_SERVICE_WIRE_PAYLOAD_FIELD_STRING, true},
};
...
static const struct mem_service_wire_payload_field
    mem_service_wire_mapping_transition_fields[] = {
        ...
        {"session_id", MEM_SERVICE_WIRE_PAYLOAD_FIELD_STRING, true},
        {"generation", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U64, true},
        {"mapping_id", MEM_SERVICE_WIRE_PAYLOAD_FIELD_U64, true},
...
static const struct mem_service_wire_operation_schema
    mem_service_wire_operation_schemas[] = {
        ...
        {MEM_SERVICE_WIRE_OP_PUBLISH_ALLOCATION,
         ...
         NULL,
         0},
        {MEM_SERVICE_WIRE_OP_MAPPING_TRANSITION,
         "mapping_transition",
         MEM_SERVICE_WIRE_SCHEMA_VERSION,
         MEM_SERVICE_WIRE_SCHEMA_FORMAT_TEXT_KV,
         mem_service_wire_mapping_transition_fields,
        ...
        {MEM_SERVICE_WIRE_OP_FENCE_ALLOCATION_HOLDER,
         "fence_allocation_holder",
         MEM_SERVICE_WIRE_SCHEMA_VERSION,
         MEM_SERVICE_WIRE_SCHEMA_FORMAT_TEXT_KV,
         mem_service_wire_fence_allocation_holder_fields,
         sizeof(mem_service_wire_fence_allocation_holder_fields) /
             sizeof(mem_service_wire_fence_allocation_holder_fields[0]),
         NULL,
         0},
};
